                    ...
                    <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div className="p-6 bg-emerald-700 text-white">
                            ...
                            <p className="text-emerald-100">
                                Complete el formulario para reservar esta
                                parcela
                            </p>
                        </div>
                                    ...
                                    <div className="mb-6">
                                        <div className="flex items-start">
                                            <input
                                                ...
                                                onChange={handleChange}
                                                className={`mt-1 rounded text-emerald-600 focus:ring-emerald-500 mr-2 ${
                                                    errors.terms
                                                        ? "border-red-500"
                                                        : ""
                                                }`}
                                            ...
                                            >
                                                Al marcar esta casilla, acepto
                                                los términos y condiciones de la
                                                reserva. Entiendo que esta es
                                                una carta de reserva y no
                                                constituye un contrato
                                                definitivo de compraventa. La
                                                reserva tiene una vigencia de 5
                                                días hábiles, período durante el
                                                cual un agente inmobiliario se
                                                contactará conmigo para
                    ...
                    <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div className="p-8 text-center">
                            ...
                            <p className="text-gray-600 mb-8">
                                Se ha enviado una copia de la carta de reserva a

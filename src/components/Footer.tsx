    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-semibold">Inmobiliaria JC Ulloa</h3>
            </div>
            <p className="text-gray-400 mb-4">
              Parcelas de 5.000 m² en la hermosa región del Bío Bío, el lugar perfecto para
              descansar y disfrutar de la naturaleza.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">info@jculloa.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} Inmobiliaria JC Ulloa. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
